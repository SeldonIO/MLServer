...
async def test_custom_handler(prometheus_registry: CollectorRegistry, rest_client, inference_request: InferenceRequest):
...
async def test_gzip_compression(prometheus_registry: CollectorRegistry, rest_client, inference_request, sum_model_settings):
