...
def test_add_custom_handlers(prometheus_registry: CollectorRegistry, rest_server: RESTServer, sum_model: SumModel):
...
async def test_delete_custom_handlers(prometheus_registry: CollectorRegistry, rest_server: RESTServer, sum_model: SumModel):
