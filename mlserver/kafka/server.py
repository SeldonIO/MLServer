...
class KafkaServer:
    ...
    async def start(self):
        ...
        async for request in self._consumer:
            ...
            request_headers: Dict[str, str] = {k: v.decode("utf-8") for k, v in request.headers}
            ...
            if not request_method or request_method == KafkaMethodTypes.infer:
                ...
                infer_response = await self._data_plane.infer(infer_request, infer_model, infer_version)
