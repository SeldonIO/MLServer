...
class HelloRequest(_message.Message):
    ...
    num_greetings: str
    def __init__(
        self, name: _Optional[str] = ..., num_greetings: _Optional[str] = ...
    ) -> None: ...
...
class RepositoryIndexRequest(_message.Message):
    ...
    ready: bool
    def __init__(
        self, repository_name: _Optional[str] = ..., ready: bool = ...
    ) -> None: ...
...
class RepositoryIndexResponse(_message.Message):
    ...
    def __init__(
        self,
        models: _Optional[
            _Iterable[_Union[RepositoryIndexResponse.ModelIndex, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class RepositoryModelLoadRequest(_message.Message):
    ...
    class ParametersEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[ModelRepositoryParameter, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        repository_name: _Optional[str] = ...,
        model_name: _Optional[str] = ...,
        parameters: _Optional[_Mapping[str, ModelRepositoryParameter]] = ...,
    ) -> None: ...
