...
from mlserver_huggingface.codecs import MultiInputRequestCodec
...
def test_decode_request(inference_request, expected):
    payload = MultiInputRequestCodec.decode_request(inference_request)
        ...
        (
            ...
            InferenceRequest(
                parameters=Parameters(
                    content_type=MultiInputRequestCodec.ContentType
                ),
                inputs=[
                    RequestInput(
                        name="foo",
...
def test_encode_request(payload, use_bytes, expected):
    inference_request = MultiInputRequestCodec.encode_request(
...
def test_decode_response(inference_response, expected):
    payload = MultiInputRequestCodec.decode_response(inference_response)
...
def test_encode_response(payload, use_bytes, expected):
    inference_response = MultiInputRequestCodec.encode_response(
