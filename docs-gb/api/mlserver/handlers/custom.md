# Module `mlserver.handlers.custom`
...
**Signature:** `custom_handler(rest_path: str, rest_method: str = 'POST')`


**Description:**
*No docstring available.*

## Function `get_custom_handlers`


**Signature:** `get_custom_handlers(model: mlserver.model.MLModel) -> List[Tuple[mlserver.handlers.custom.CustomHandler, Callable[..., Any]]]`


**Description:**
*No docstring available.*

## Function `register_custom_handler`


**Signature:** `register_custom_handler(handler: mlserver.handlers.custom.CustomHandler, method: Callable[..., Any])`
