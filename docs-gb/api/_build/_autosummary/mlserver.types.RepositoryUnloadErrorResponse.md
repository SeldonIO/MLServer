...
**Qualified name:** `mlserver.types.RepositoryUnloadErrorResponse`

## Overview

### *class* mlserver.types.RepositoryUnloadErrorResponse
...
#### RepositoryUnloadErrorResponse.\_\_init_\_(\*\*data)
